...
//    }
    ...
    void setDeaths_a(int deaths_a) {
        this.deaths_a = deaths_a;
    }

    void setDeaths_b(int deaths_b) {
        this.deaths_b = deaths_b;
    }

//    void setPlayer_a(int player_a) {
//        this.player_a = player_a;
//    }

//    void setPlayer_b(int player_b) {
//        this.player_b = player_b;
//    }

    void setScore_a(int score_a) {
        this.score_a = score_a;
    }

    void setScore_b(int score_b) {
        this.score_b = score_b;
    }
}
